#include <stdio.h> #include <ctype.h>
 ...
 int charClass; char lexeme [100]; char nextChar;
...
if ((in_fp = fopen("front.in", "r")) == NULL) printf("ERROR - cannot open front.in n");
...
case UNKNOWN: lookup(nextChar); getChar();
...
case EOF: nextToken = EOF; lexeme[0] = 'E';
